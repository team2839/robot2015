...
public class TurnTableSubsystem extends PIDSubsystem {
    ...
    public TurnTableSubsystem() {
    	super("TurnTableSubsystem", PIDConstants.TURNTABLE_P, PIDConstants.TURNTABLE_I, PIDConstants.TURNTABLE_D);
    	...
    	LiveWindow.addActuator("TurnTableSubsystem", "PIDSubsystem Controller",
				getPIDController());
    	getPIDController().setOutputRange(PIDConstants.TURNTABLE_OUTPUT_MIN, PIDConstants.TURNTABLE_OUTPUT_MAX);
		getPIDController().setInputRange(PIDConstants.TURNTABLE_INPUT_MIN, PIDConstants.TURNTABLE_INPUT_MAX);
    }
