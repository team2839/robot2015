...
public class FrontToteLiftCommand extends Command {

	private double setpoint;

	public FrontToteLiftCommand(double setpoint) {
	...
	protected void execute() {
		Robot.frontTotePickupSubsystem.enable();
		Robot.frontTotePickupSubsystem.setSetpoint(setpoint);
	}

	// Make this return true when this Command no longer needs to run execute()
	protected boolean isFinished() {
		return Robot.frontTotePickupSubsystem.onTarget()
				|| RobotMap.frontTotePickupTopLimitSwitch.get()
				|| RobotMap.frontTotePickupBottomLimitSwitch.get();
	}
