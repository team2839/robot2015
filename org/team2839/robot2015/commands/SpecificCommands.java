...
public class SpecificCommands {
	...
	public static TurretMoveCommand turretToLeft = new TurretMoveCommand(
			GeneralConstants.TURRET_PULSES_PER_REVOLUTION);
	public static TurretMoveCommand turretTo45OffBack = new TurretMoveCommand(
			GeneralConstants.TURRET_POSITION_45_OFF_BACK
					/ GeneralConstants.TURRET_DEGREES_PER_PULSE);
